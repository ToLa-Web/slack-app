...
const Editor = ({ 
  ...
  const [isToolbarVisible, setIsIoolbarVisible] = useState(true)
  ...
  const toggleToolbar = () => {
    setIsIoolbarVisible((current) => !current);
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className={cn(
        ...
        {!!image && (
          <div className="p-2">
            <div className="relative size-[62px] items-center justify-center group/image">
              <button
                onClick={() => {
                  setImage(null)
